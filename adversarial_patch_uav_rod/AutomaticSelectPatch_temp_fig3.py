...
def test_one_image():
    ...
    """
    # 新建临时存储文件夹
    temp_work_dir = './vis_results_DSAP/select_diverse_stealthy_patches/fig3'
    ...
    # response中
    original_image_path = '../../datasets/UAV-ROD/train_640x360/images/DJI_0039_011280.png'
    generator_checkpoint = './train_DSAP_uavrod/train_NewSourceDomain_20250614/checkpoints/netG_epoch1200.pth'
    ...
    # load position
    positions = [
        {'center': (228, 84), 'angle': -45},
        {'center': (509, 95), 'angle': -45}
        ]
