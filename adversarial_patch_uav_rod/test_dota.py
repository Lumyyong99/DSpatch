...
from ensemble_tools.utils0 import find_patch_positions_v3, weights_init, convert_to_le90
...
parser.add_argument('--patch_ratio_range', default=0.01, type=float, help='patch zooming ratio. default=0.1. meaning: [patch_ratio-patch_ratio_range, patch_ratio+patch_ratio_range')
# test setting
...
parser.add_argument('--victim_detector', default='retinanet_o', help='victim detector')
parser.add_argument('--source_detector', default='retinanet_o', help='target detector')
# set generator
parser.add_argument('--custom_generator', action='store_true', default=False, help='Manually customize generator')
parser.add_argument('--generator', default='', type=str, help='path of net G')
...
if args.victim_detector == 'retinanet_o':
...
elif args.victim_detector == 'faster_rcnn_o':
    DetectorCfgSource = '/home/yyx/Adversarial/mmrotate-0.3.3/UAV-ROD_training/configs/rotated_faster_rcnn/rotated_faster_rcnn_r50_fpn_1x_uavrod_le90.py'
    DetectorCheckpoint = '/home/yyx/Adversarial/mmrotate-0.3.3/UAV-ROD_training/detection_model/detectors_640x360/faster_rcnn_o/latest.pth'
elif args.victim_detector == 'gliding_vertex':
    DetectorCfgSource = '/home/yyx/Adversarial/mmrotate-0.3.3/UAV-ROD_training/configs/gliding_vertex/gliding_vertex_r50_fpn_1x_uavrod_le90.py'
    DetectorCheckpoint = '/home/yyx/Adversarial/mmrotate-0.3.3/UAV-ROD_training/detection_model/detectors_640x360/gliding_vertex/latest.pth'
elif args.victim_detector == 'oriented_rcnn':
    DetectorCfgSource = '/home/yyx/Adversarial/mmrotate-0.3.3/UAV-ROD_training/configs/oriented_rcnn/oriented_rcnn_r50_fpn_1x_uavrod_le90.py'
    DetectorCheckpoint = '/home/yyx/Adversarial/mmrotate-0.3.3/UAV-ROD_training/detection_model/detectors_640x360/oriented_rcnn/latest.pth'
elif args.victim_detector == 'roi_trans':
    DetectorCfgSource = '/home/yyx/Adversarial/mmrotate-0.3.3/UAV-ROD_training/configs/roi_trans/roi_trans_r50_fpn_1x_uavrod_le90.py'
    DetectorCheckpoint = '/home/yyx/Adversarial/mmrotate-0.3.3/UAV-ROD_training/detection_model/detectors_640x360/roi_trans/latest.pth'
elif args.victim_detector == 's2anet':
    DetectorCfgSource = '/home/yyx/Adversarial/mmrotate-0.3.3/UAV-ROD_training/configs/s2anet/s2anet_r50_fpn_1x_uavrod_le90.py'
    DetectorCheckpoint = '/home/yyx/Adversarial/mmrotate-0.3.3/UAV-ROD_training/detection_model/detectors_640x360/s2anet/latest.pth'
elif args.victim_detector == 'retinanet_o_defence':
    DetectorCfgSource = '/home/yyx/Adversarial/mmrotate-0.3.3/UAV-ROD_training/configs/rotated_retinanet/rotated_retinanet_obb_r50_fpn_1x_uavrod_le90.py'
    DetectorCheckpoint = '/home/yyx/Adversarial/mmrotate-0.3.3/UAV-ROD_training/detection_model/detectors_640x360/rotated_retinanet_finetune/latest.pth'
else:
    raise Exception('Wrong Victim Detector!')
victim_detector = args.victim_detector


if args.source_detector == 'retinanet_o':
    netG_path = '/home/yyx/Adversarial/mmrotate-0.3.3/adversarial_patch_uav_rod/train_GANpatch_files/multidetector_alpha0.1_beta1.0_gamma0.1_patchsize0.6_patchrange0.1/final_scene_VictimDetector_retinanet_o_PatchSize0.6_PatchRange0.1/checkpoints/netG_epoch500.pth'
elif args.source_detector == 'faster_rcnn_o':
    netG_path = '/home/yyx/Adversarial/mmrotate-0.3.3/adversarial_patch_uav_rod/train_GANpatch_files/multidetector_alpha0.1_beta1.0_gamma0.1_patchsize0.6_patchrange0.1/final_scene_VictimDetector_roi_trans_PatchSize0.6_PatchRange0.1_seed2026/checkpoints/netG_epoch500.pth'
elif args.source_detector == 'gliding_vertex':
    netG_path = '/home/yyx/Adversarial/mmrotate-0.3.3/adversarial_patch_uav_rod/train_GANpatch_files/multidetector_alpha0.1_beta1.0_gamma0.1_patchsize0.6_patchrange0.1/final_scene_VictimDetector_gliding_vertex_PatchSize0.6_PatchRange0.1/checkpoints/netG_epoch500.pth'
elif args.source_detector == 'oriented_rcnn':
    netG_path = '/home/yyx/Adversarial/mmrotate-0.3.3/adversarial_patch_uav_rod/train_GANpatch_files/multidetector_alpha0.1_beta1.0_gamma0.1_patchsize0.6_patchrange0.1/final_scene_VictimDetector_oriented_rcnn_PatchSize0.6_PatchRange0.1_seed2025/checkpoints/netG_epoch500.pth'
elif args.source_detector == 'roi_trans':
    netG_path = '/home/yyx/Adversarial/mmrotate-0.3.3/adversarial_patch_uav_rod/train_GANpatch_files/multidetector_alpha0.1_beta1.0_gamma0.1_patchsize0.6_patchrange0.1/final_scene_VictimDetector_roi_trans_PatchSize0.6_PatchRange0.1_seed2026/checkpoints/netG_epoch500.pth'
elif args.source_detector == 's2anet':
    netG_path = '/home/yyx/Adversarial/mmrotate-0.3.3/adversarial_patch_uav_rod/train_GANpatch_files/multidetector_alpha0.1_beta1.0_gamma0.1_patchsize0.6_patchrange0.1/final_scene_VictimDetector_s2anet_PatchSize0.6_PatchRange0.1/checkpoints/netG_epoch500.pth'
else:
    raise Exception('Wrong target Detector!')
source_detector = args.source_detector

if args.custom_generator:
    netG_path = args.generator
...
# scene setting
ContinuousFramesImageFolder = "/home/yyx/Adversarial/datasets/DOTA-V1.0/DOTA-plane-200/images"
ContinuousFramesLabelFolder = "/home/yyx/Adversarial/datasets/DOTA-V1.0/DOTA-plane-200/labelTxt"
...
### -----------------------------------------------------------   preparing   ---------------------------------------------------------------------- ###
# prepare generator
netG = dcgan.DCGAN_G(rowPatch_size, nz, nc, ngf, ngpu, G_extra_layers)
...
# load to gpu
# patch_seeds = torch.FloatTensor(patch_per_image, nz, 1, 1).normal_(0, 1)  # 一次为一张图生成patch_per_image张补丁。   # TODO：如果在这里设定patch_seeds，每幅图生成的补丁就是一样的。
if device == "cuda:0":
    netG.cuda()
    # patch_seeds = patch_seeds.cuda()
...
for epoch in tqdm(range(test_epoch)):
    ...
    for scene_bag in tqdm(group_dict_list):
        ...
        # 对生成的补丁进行apply
        fake_patch = generated_patch.view(scene_image_batch_size, patch_per_image, 3, 64, 64)
        ...
        # 进行apply
        img_size = (384, 640)
        adv_batch_masked, msk_batch = patch_transformer.forward2(adv_batch=fake_patch,
        ...
        if args.custom_fake_object_size:
            patch_positions_batch_t[:, :, 2] = args.fake_width
            patch_positions_batch_t[:, :, 3] = args.fake_height
