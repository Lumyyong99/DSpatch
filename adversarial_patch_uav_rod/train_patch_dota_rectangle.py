...
elif args.patch_pattern == 'forest':
    GAN_dataset = '/home/yyx/Adversarial/datasets/natural-scenes/seg_train/forest'
else:
...
# scene setting
ContinuousFramesImageFolder = f"/home/yyx/Adversarial/datasets/DOTA-V1.0/DOTA-{class_name}/DOTA-{class_name}-200/images"
ContinuousFramesLabelFolder = f"/home/yyx/Adversarial/datasets/DOTA-V1.0/DOTA-{class_name}/DOTA-{class_name}-200/labelTxt"
...
patch_size = [64, 64*patch_aspect_ratio]
...
for epoch in range(start_epoch, n_epochs):
    ...
    while i < len(PatchDataloader):
        ...
        for gen_flag in range(args.Giters):
            ...
            # patch_position确定
            # patch_location_range = (512, 512)       # z这里意思是在范围(360, 640)内选择位置
            # patch_positions_list = []
