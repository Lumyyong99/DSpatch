...
# detector: 不测迁移性，victim_detector和source_detector（对应的netG）保持一致，都用detector代表
parser.add_argument('--detector', default='retinanet_o', help='test target detector')
parser.add_argument('--netG', default='', help='generator checkpoint')
...
if args.detector == 'retinanet_o':
    DetectorCfgSource = '/home/Adversarial/mmrotate-0.3.3/DOTA_models/configs/rotated_retinanet/rotated_retinanet_obb_r50_fpn_1x_dota_le90.py'
    DetectorCheckpoint = '/home/Adversarial/mmrotate-0.3.3/DOTA_models/detection_models/pre-trained_models/rotated_retinanet_obb_r50_fpn_1x_dota_le90-c0097bc4.pth'
elif args.detector == 'faster_rcnn_o':
    DetectorCfgSource = '/home/Adversarial/mmrotate-0.3.3/DOTA_models/configs/rotated_faster_rcnn/rotated_faster_rcnn_r50_fpn_1x_dota_le90.py'
    DetectorCheckpoint = '/home/Adversarial/mmrotate-0.3.3/DOTA_models/detection_models/pre-trained_models/rotated_faster_rcnn_r50_fpn_1x_dota_le90-0393aa5c.pth'
elif args.detector == 'gliding_vertex':
    DetectorCfgSource = '/home/Adversarial/mmrotate-0.3.3/DOTA_models/configs/gliding_vertex/gliding_vertex_r50_fpn_1x_dota_le90.py'
    DetectorCheckpoint = '/home/Adversarial/mmrotate-0.3.3/DOTA_models/detection_models/pre-trained_models/gliding_vertex_r50_fpn_1x_dota_le90-12e7423c.pth'
elif args.detector == 'oriented_rcnn':
    DetectorCfgSource = '/home/Adversarial/mmrotate-0.3.3/DOTA_models/configs/oriented_rcnn/oriented_rcnn_r50_fpn_1x_dota_le90.py'
    DetectorCheckpoint = '/home/Adversarial/mmrotate-0.3.3/checkpoints/oriented_rcnn_r50_fpn_1x_dota_le90-6d2b2ce0.pth'
elif args.detector == 'roi_trans':
    DetectorCfgSource = '/home/Adversarial/mmrotate-0.3.3/DOTA_models/configs/roi_trans/roi_trans_r50_fpn_1x_dota_le90.py'
    DetectorCheckpoint = '/home/Adversarial/mmrotate-0.3.3/DOTA_models/detection_models/pre-trained_models/roi_trans_r50_fpn_1x_dota_le90-d1f0b77a.pth'
elif args.detector == 's2anet':
    # 这里还不确定
    DetectorCfgSource = '/home/Adversarial/mmrotate-0.3.3/DOTA_models/configs/s2anet/s2anet_r50_fpn_1x_dota_le135.py'
    DetectorCheckpoint = '/home/Adversarial/mmrotate-0.3.3/DOTA_models/detection_models/pre-trained_models/s2anet_r50_fpn_1x_dota_le135-5dfcf396.pth'
else:
...
# scene setting
ContinuousFramesImageFolder = f"/home/Adversarial/datasets/DOTA-V1.0/DOTA-{class_name}-propersize-scene50/images"
ContinuousFramesLabelFolder = f"/home/Adversarial/datasets/DOTA-V1.0/DOTA-{class_name}-propersize-scene50/labelTxt"
