...
parser.add_argument('--ifgsm_iter', default=30, type=int, help='iteration number of I-FGSM.')
parser.add_argument('--epsilon', default=1.0, type=float, help='epsilon of I-FGSM')
parser.add_argument('--alpha', default=0.15, type=float, help='alpha of I-FGSM')
# test setting
...
if victim_detector == 'retinanet_o':
    DetectorCfgSource = '/home/yyx/Adversarial/mmrotate-0.3.3/UAV-ROD_models/configs/rotated_retinanet_IFGSM_defense/rotated_retinanet_obb_r50_fpn_1x_uavrod_le90_defense.py'
    DetectorCheckpoint = '/home/yyx/Adversarial/mmrotate-0.3.3/UAV-ROD_models/detection_model/detectors_640x360/rotated_retinanet-defense-IFGSM-2/latest.pth'
elif victim_detector == 'faster_rcnn_o':
    DetectorCfgSource = '/home/yyx/Adversarial/mmrotate-0.3.3/UAV-ROD_models/configs/rotated_faster_rcnn_IFGSM_defense/rotated_faster_rcnn_r50_fpn_1x_uavrod_le90_defense.py'
    DetectorCheckpoint = '/home/yyx/Adversarial/mmrotate-0.3.3/UAV-ROD_models/detection_model/detectors_640x360/faster_rcnn_o-defense-IFGSM/latest.pth'
elif victim_detector == 'gliding_vertex':
    DetectorCfgSource = '/home/yyx/Adversarial/mmrotate-0.3.3/UAV-ROD_models/configs/gliding_vertex_IFGSM_defense/gliding_vertex_r50_fpn_1x_uavrod_le90_defense.py'
    DetectorCheckpoint = '/home/yyx/Adversarial/mmrotate-0.3.3/UAV-ROD_models/detection_model/detectors_640x360/gliding_vertex-defense-IFGSM/latest.pth'
elif victim_detector == 'oriented_rcnn':
    DetectorCfgSource = '/home/yyx/Adversarial/mmrotate-0.3.3/UAV-ROD_models/configs/oriented_rcnn_IFGSM_defense/oriented_rcnn_r50_fpn_1x_uavrod_le90_defense.py'
    DetectorCheckpoint = '/home/yyx/Adversarial/mmrotate-0.3.3/UAV-ROD_models/detection_model/detectors_640x360/oriented_rcnn-defense-IFGSM/latest.pth'
elif victim_detector == 'roi_trans':
    DetectorCfgSource = '/home/yyx/Adversarial/mmrotate-0.3.3/UAV-ROD_models/configs/roi_trans_IFGSM_defense/roi_trans_r50_fpn_1x_uavrod_le90_defense.py'
    DetectorCheckpoint = '/home/yyx/Adversarial/mmrotate-0.3.3/UAV-ROD_models/detection_model/detectors_640x360/roi_trans-defense-IFGSM/latest.pth'
elif victim_detector == 's2anet':
    DetectorCfgSource = '/home/yyx/Adversarial/mmrotate-0.3.3/UAV-ROD_models/configs/s2anet_IFGSM_defense/s2anet_r50_fpn_1x_uavrod_le90_defense.py'
    DetectorCheckpoint = '/home/yyx/Adversarial/mmrotate-0.3.3/UAV-ROD_models/detection_model/detectors_640x360/s2anet-defense-IFGSM/latest.pth'
else:
...
Patch_per_Image = 2  # 这里固定为1，FGSM中一张图设定为一个fake bounding box
img_size = (384, 640)
...
def I_FGSM_creation_attack(model, device, scene_bag, fake_positions, fake_labels, epsilon, alpha, num_iter):
    ...
    # 进行I-FGSM攻击
    pseudo_fake_patch = torch.ones((image_BatchSize, Patch_per_Image, 3, perturbed_h, perturbed_w)).to(device)
...
def classify_boxes(det_boxes, real_boxes, fake_boxes, iou_threshold=0.5):
    ...
    Parameters:
        ...
        fake_boxes(torch.Tensor): fake object boxes, [[cx, cy, w, h, theta]]
