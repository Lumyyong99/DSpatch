...
parser.add_argument('--lr', default=0.0005, type=float, help='learning rate of Generator')
...
parser.add_argument('--epochs', default=1000, type=int, help='total epoch number for training process')
...
for epoch in range(n_epochs):
    ...
    for scene_bag in tqdm(group_dict_list):
        ...
        for one_image_annotations in batch_images_annotations:      # one_image_annotations表示一个图里面的annotation
            ...
            patch_location_range = (512, 512)       # z这里意思是在范围(512, 512)内选择位置
