...
log 2025.1.15
用于测试advpatch补丁的防御性能，使用经过对抗训练的检测器
"""
import argparse
...
if victim_detector == 'retinanet_o':
    DetectorCfgSource = '/home/yyx/Adversarial/mmrotate-0.3.3/UAV-ROD_models/configs/rotated_retinanet_advpatch_defense/rotated_retinanet_obb_r50_fpn_1x_uavrod_le90_defense.py'
    DetectorCheckpoint = '/home/yyx/Adversarial/mmrotate-0.3.3/UAV-ROD_models/detection_model/detectors_640x360/rotated_retinanet-defense-advpatch/latest.pth'
elif victim_detector == 'faster_rcnn_o':
    DetectorCfgSource = '/home/yyx/Adversarial/mmrotate-0.3.3/UAV-ROD_models/configs/rotated_faster_rcnn_advpatch_defense/rotated_faster_rcnn_r50_fpn_1x_uavrod_le90_defense.py'
    DetectorCheckpoint = '/home/yyx/Adversarial/mmrotate-0.3.3/UAV-ROD_models/detection_model/detectors_640x360/faster_rcnn_o-defense-advpatch/latest.pth'
elif victim_detector == 'gliding_vertex':
    DetectorCfgSource = '/home/yyx/Adversarial/mmrotate-0.3.3/UAV-ROD_models/configs/gliding_vertex_advpatch_defense/gliding_vertex_r50_fpn_1x_uavrod_le90_defense.py'
    DetectorCheckpoint = '/home/yyx/Adversarial/mmrotate-0.3.3/UAV-ROD_models/detection_model/detectors_640x360/gliding_vertex-defense-advpatch/latest.pth'
elif victim_detector == 'oriented_rcnn':
    DetectorCfgSource = '/home/yyx/Adversarial/mmrotate-0.3.3/UAV-ROD_models/configs/oriented_rcnn_advpatch_defense/oriented_rcnn_r50_fpn_1x_uavrod_le90_defense.py'
    DetectorCheckpoint = '/home/yyx/Adversarial/mmrotate-0.3.3/UAV-ROD_models/detection_model/detectors_640x360/oriented_rcnn-defense-advpatch/latest.pth'
elif victim_detector == 'roi_trans':
    DetectorCfgSource = '/home/yyx/Adversarial/mmrotate-0.3.3/UAV-ROD_models/configs/roi_trans_advpatch_defense/roi_trans_r50_fpn_1x_uavrod_le90_defense.py'
    DetectorCheckpoint = '/home/yyx/Adversarial/mmrotate-0.3.3/UAV-ROD_models/detection_model/detectors_640x360/roi_trans-defense-advpatch/latest.pth'
elif victim_detector == 's2anet':
    DetectorCfgSource = '/home/yyx/Adversarial/mmrotate-0.3.3/UAV-ROD_models/configs/s2anet_advpatch_defense/s2anet_r50_fpn_1x_uavrod_le90_defense.py'
    DetectorCheckpoint = '/home/yyx/Adversarial/mmrotate-0.3.3/UAV-ROD_models/detection_model/detectors_640x360/s2anet-defense-advpatch/latest.pth'
else:
...
if victim_detector == 'retinanet_o':
    patch_pt_path = '/home/yyx/Adversarial/mmrotate-0.3.3/adversarial_patch_uav_rod/train_advpatch_uavrod/advpatch_retinanet_o_uavrod/patch_pt/patch_epoch300.pt'
elif victim_detector == 'faster_rcnn_o':
    patch_pt_path = '/home/yyx/Adversarial/mmrotate-0.3.3/adversarial_patch_uav_rod/train_advpatch_uavrod/advpatch_faster_rcnn_o_uavrod/patch_pt/patch_epoch300.pt'
elif victim_detector == 'gliding_vertex':
    patch_pt_path = '/home/yyx/Adversarial/mmrotate-0.3.3/adversarial_patch_uav_rod/train_advpatch_uavrod/advpatch_gliding_vertex_uavrod/patch_pt/patch_epoch300.pt'
elif victim_detector == 'oriented_rcnn':
    patch_pt_path = '/home/yyx/Adversarial/mmrotate-0.3.3/adversarial_patch_uav_rod/train_advpatch_uavrod/advpatch_oriented_rcnn_uavrod/patch_pt/patch_epoch300.pt'
elif victim_detector == 'roi_trans':
    patch_pt_path = '/home/yyx/Adversarial/mmrotate-0.3.3/adversarial_patch_uav_rod/train_advpatch_uavrod/advpatch_roi_trans_uavrod/patch_pt/patch_epoch300.pt'
elif victim_detector == 's2anet':
    patch_pt_path = '/home/yyx/Adversarial/mmrotate-0.3.3/adversarial_patch_uav_rod/train_advpatch_uavrod/advpatch_s2anet_uavrod/patch_pt/patch_epoch300.pt'
else:
    raise Exception('Wrong Victim Detector!')

patch = torch.load(patch_pt_path)
# 对fake_patch进行范围限制
