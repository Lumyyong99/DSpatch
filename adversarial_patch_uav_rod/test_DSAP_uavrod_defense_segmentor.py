...
if args.detector == 'retinanet_o':
    netG_path = '/home/Adversarial/mmrotate-0.3.3/adversarial_patch_uav_rod/train_DSAP_rect_patch/multidetectors/DSAP_retinanet_uavrod/checkpoints/netG_epoch1200.pth'
elif args.detector == 'faster_rcnn_o':
    netG_path = '/home/Adversarial/mmrotate-0.3.3/adversarial_patch_uav_rod/train_DSAP_rect_patch/multidetectors/DSAP_faster_rcnn_uavrod/checkpoints/netG_epoch1200.pth'
elif args.detector == 'gliding_vertex':
    netG_path = '/home/Adversarial/mmrotate-0.3.3/adversarial_patch_uav_rod/train_DSAP_rect_patch/multidetectors/DSAP_gliding_vertex_uavrod/checkpoints/netG_epoch1200.pth'
# elif args.detector == 'oriented_rcnn':
...
# segmentor_checkpoint = './train_segmentor/segmentor_DSAP/segmentor_retinanet/segmentor_checkpoints/epoch_40_model.pth'      ###!!!
if args.detector == 'retinanet_o':
    segmentor_checkpoint = './segmentor_training_DSAP_retinanet/segmentor_checkpoints/epoch_40_model.pth'
elif args.detector == 'faster_rcnn_o':
    segmentor_checkpoint = './segmentor_training_DSAP_faster-rcnn/segmentor_checkpoints/epoch_10_model.pth'
elif args.detector == 'gliding_vertex':
    segmentor_checkpoint = './segmentor_training_DSAP_gliding-vertex/segmentor_checkpoints/epoch_10_model.pth'
else:
    print('wrong segmentor')
    assert False
