...
parser.add_argument('--patch_ratio', default=1.0, type=float, help='patch size ratio during testing. select from [0.5, 0.7, 1.0, 1.5]')
# test setting
...
parser.add_argument('--netG',default='', help='generator path')
