...
from ensemble_tools.patch_dataloader import ScenePatch
...
parser.add_argument('--patch_pattern', default='scene', help="patch patten. Select from [scene].")
...
if args.patch_pattern == 'scene':
    ...
    # GAN_dataset = '/home/Adversarial/datasets/UAV-ROD/source_domain_32x64'
    GAN_dataset = '/home/Adversarial/datasets/UAV-ROD/source_domain_append_32x64'
else:
